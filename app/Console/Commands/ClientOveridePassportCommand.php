...
class ClientOveridePassportCommand extends Command
{
    /**
...
//        }
     ...
     */
    protected
    function createPersonalClient(ClientRepository $clients)
    {
     ...
     */
    protected
    function createPasswordClient(ClientRepository $clients)
    {
        $name = $this->option('name') ?: $this->ask(
     ...
     */
    protected
    function createClientCredentialsClient(ClientRepository $clients)
    {
        $name = $this->option('name') ?: $this->ask(
     ...
     */
    protected
    function createAuthCodeClient(ClientRepository $clients)
    {
     ...
     */
    protected
    function outputClientDetails(Client $client)
    {
