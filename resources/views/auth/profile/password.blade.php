        ...
        <div class="container">
            ...
            <div class="login-form">
                ...
                @if (session('notification_success'))
                    <div class="text-success" style="margin-bottom: 10px;">{{ session('notification_success') }}</div>
                @endif

                <div class="login-form-header">
                    <h2 class="modal-title mb-1">Đổi mật khẩu</h2>
                </div>

                <form class="login-form-groups" method="POST"
                      action="{{route('post.change.password')}}">
                    @csrf
                    <div class="form-group">
                        <label class="form-label visually-hidden" for="login-form-password">Mật khẩu cũ</label>
                        <input class="form-control @error('old_password') is-invalid @enderror" id="login-form-password"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('password') is-invalid @enderror"
                               id="login-form-password-confirm"
